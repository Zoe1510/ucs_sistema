    ...
    public partial class Nueva_formacion_Abierto : Form
    {
        ...
        private void Nueva_formacion_Load(object sender, EventArgs e)
        {
            ...
            }else //si viene referenciado desde el modulo ver formaciones, donde se cargaran los datos ingresados previamente para su modificacion
            {
                ...
                LabelCabecera.Text = "      Abierto: Información básica";
        ...
        private void CargarDatosEtapaDos()
        {
            ...
            formacion.dia1 = dtpFechaCurso.Value;
            formacion.bloque_curso = Cursos.bloque_curso13;
            if (Cursos.bloque_curso13 == "2")
            {
                ...
                formacion.dia2 = dtpSegundaFecha.Value;
            }
            else
            {
                dtpSegundaFecha.Enabled = false;
        ...
        private void GuardarIntermedio()
        {
            try
            {
                ...
                if (Formaciones.creacion == true)
                {
                    ...
                    MySqlDataReader obtener_id_curso = Conexion.ConsultarBD("SELECT id_cursos FROM cursos WHERE nombre_curso = '" + txtNombreFormacion.Text + "' AND tipo_curso='Abierto'  AND estatus_curso='En curso' AND duracion_curso=" + formacion.duracion + " AND id_usuario1='" + formacion.id_user + "' and solicitud_curso='" + txtSolicitadoPor.Text + "'");
                    ...
                    }else
                    {
                        ...
                        }else
                        {
                            ...
                            } else
                            {
                                ...
                                //crear una lista donde se agreguen los nombres de cada fila para luego buscar el id de ellos (los seleccionados) y guardarlo en la bd
        ...
        private void btnSiguienteEtapa_Click(object sender, EventArgs e)
        {
            ...
            else //si viene referenciado desde modificar
            {
                ...
                else if (pnlNivel_intermedio.Visible == true)
                {
                    ...
                    LabelCabecera.Text = "           Abierto: Logística";
                    LabelCabecera.Location = new Point(250, 31);
        ...
        #region EtapaIntermedia eventos
